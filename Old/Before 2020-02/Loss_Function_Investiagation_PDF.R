...
for(j in seq_len(M)){
  ...
  ### lm and from LASSO
  pdf(paste0("Plots/Profile Likelihood - LS/Profile Likelihood LS - ",
             j, ".pdf"))
  ...
  dev.off()
  pdf(paste0("Plots/Profile Likelihood - LASSO/",
  ...
  pdf(paste0("Plots/Zoomed Profile Likelihood - LS/",
  ...
  abline(v = 1, lwd = 1, col = "blue")
  dev.off()
  pdf(paste0("Plots/Zoomed Profile Likelihood - LASSO/",
  ...
  pdf(paste0("Plots/Log-Lambda Min/",
             "Log Lambda Min - ",
             j, ".pdf"))
  ...
  pdf(paste0("Plots/Log-Lambda 1SE/",
             "Log Lambda 1SE - ",
             j, ".pdf"))
