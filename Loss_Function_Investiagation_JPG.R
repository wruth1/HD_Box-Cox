...
for (j in 1:M) {
  ...
  ### lm and from LASSO
  jpeg(paste0(
    "Plots/Profile Likelihood - LS/Profile Likelihood LS - ",
    j,
    ".jpg"
  ))
  plot(
  ...
  jpeg(
    paste0(
      "Plots/Profile Likelihood - LASSO/",
  ...
  jpeg(
    paste0(
      "Plots/Zoomed Profile Likelihood - LS/",
  ...
  jpeg(
    paste0(
      "Plots/Zoomed Profile Likelihood - LASSO/",
  ...
  ### Add uncertainty measure to zoomed profile likelihood plots
  jpeg(
    paste0(
      "Plots/Zoomed Profile Likelihood w Errors - LS/",
      "Zoomed Profile Likelihood w Errors LS  - ",
      j,
      ".jpg"
    )
  )
  ...
  jpeg(
    paste0(
      "Plots/Zoomed Profile Likelihood w Errors - LASSO/",
      "Zoomed Profile Likelihood w Errors LASSO min - ",
      j,
      ".jpg"
    )
  )
  ...
  jpeg(
    paste0(
      "Plots/Zoomed Profile Likelihood w Errors - LASSO/",
      "Zoomed Profile Likelihood w Errors LASSO 1se - ",
      j,
      ".jpg"
    )
  )
  ...
  lines(Gammas,
        pr.lik.collection[3,j,] + pr.lik.sd[3,],
        col = "Red",
        lty = 2)
  lines(Gammas,
        pr.lik.collection[3,j,] - pr.lik.sd[3,],
